...
export default function AnalysisPage({ onNavigate, onLogout, user }: AnalysisPageProps) {
    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-display">
      ...
      <header className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-6 py-3 sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-lg font-bold leading-tight tracking-tight">AI Deneme Analizi</h2>
        </div>
        ...
        <aside className="hidden lg:flex w-72 flex-col bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 p-6 gap-8">
          <div className="flex flex-col gap-2">
            ...
            <nav className="flex flex-col gap-1">
              <SidebarItem icon={LayoutDashboard} label="Dashboard" onClick={() => onNavigate('dashboard')} />
        ...
        <main className="flex-1 p-6 md:p-10 overflow-y-auto max-w-7xl mx-auto w-full">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              ...
              >
                <h1 className="text-3xl font-black tracking-tight">Performans Raporu</h1>
                <p className="text-slate-500 text-lg">Son deneme sonuçların ve yapay zeka önerilerin hazır.</p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <motion.div
                    key={i}
                    whileHover={{ y: -5 }}
                    className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden group hover:shadow-lg transition-all cursor-pointer shadow-sm"
                  >
